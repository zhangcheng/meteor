...
test("liveui - one render", function () {
...
test("liveui - preserved nodes (diff/patch)", function () {
  ...
  var nodeListToHtml = function(list, is_after) {
    var buf = [];
    _.each(list, function(n) {
      if (is_after ? n.existsAfter : n.existsBefore) {
        if (n.text) {
          ...
          buf.push('>');
          buf.push(nodeListToHtml(n.children, is_after));
          buf.push('</', n.tagName, '>');
        }
      }
    });
...
test("liveui - copied attributes", function () {
